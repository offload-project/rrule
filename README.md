# rrule demo
`gh-pages` branch is permenently diverged from other branches to just host the demo. This way the released `@offload-project/rrule` package will not include demo content, and won't depend on `jQuery`
